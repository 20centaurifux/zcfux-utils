...
internal static class TopicKinds
{
    ...
    public static readonly ITopicKind User = new TopicKind(3, "User");
    public static readonly ITopicKind Session = new TopicKind(4, "Session");
    public static readonly ITopicKind Service = new TopicKind(5, "Service");
};