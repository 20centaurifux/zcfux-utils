...
public sealed class Store
{
    ...
    internal Store(IMailDb db, object handle)
    ...
    public Directory NewDirectory(string name)
    {
        ...
        var directory = _db.Directories.NewDirectory(_handle, name);
    ...
    public IEnumerable<Message> Query(Query query)
        => _db.Messages.Query(_handle, query)
            .Select(msg => new Message(_db, _handle, msg));
}